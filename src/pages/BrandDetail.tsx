    ...
    <div className="min-h-screen pt-24 pb-16">
      <div className="max-w-[1320px] mx-auto px-6">
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <Link to="/brands" className="font-body text-[11px] text-muted-foreground hover:text-foreground no-underline tracking-[1px] uppercase">
            ← All Brands
          </Link>
          <h1 className="font-display text-5xl md:text-6xl mt-6 mb-4 tracking-tight">{brandName}</h1>
          <p className="font-body text-muted-foreground text-[15px] max-w-lg">
            Explore the complete {brandName} collection — trusted by millions of Indian households.
          </p>
        </motion.div>

        {/* Product grid with bento feel */}
